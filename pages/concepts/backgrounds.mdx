...
page-title: Concepts / Backgrounds
...
![image](@assets/concepts/Backgrounds-Sessions.png)
...
![image](@assets/concepts/Backgrounds-CCI.png)
...
-   We use the
    [ta.percentrank()](https://www.tradingview.com/pine-script-reference/v5/#ta.percentrank)
...
See the [Colors](/pine-script-docs/concepts/colors) page for
