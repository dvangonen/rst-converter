...
sidebar-title: Bar states
page-title: Concepts / Bar states
...
[Session states](/pine-script-docs/concepts/sessions#session-states) section.
...
![image](@assets/concepts/BarStates-Example-01.png)

Let\'s look at what happens when realtime updates start coming in:

![image](@assets/concepts/BarStates-Example-02.png)
...
![image](@assets/concepts/BarStates-Example-03.png)
