...
[built-in variables](/pine-script-docs/built-in-functions#built-in-variables). The ones we cover here allow scripts to access information
relating to:
...
[repainting](/pine-script-docs/concepts/repainting). See the
...
[history-referencing operator](/pine-script-docs/language/operators#history-referencing-operator) can be used to refer to past values of the built-in
...
-   The
    ...
    [ticker.new()](https://www.tradingview.com/pine-script-reference/v5/#fun_ticker%7Bdot%7Dnew).
-   [Session state built-ins](/pine-script-docs/concepts/sessions#session-states) provide information on the trading session a bar belongs
    to.
