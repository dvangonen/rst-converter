...
`plots <PageTypeSystem_Types_PlotAndHline>`,
`hlines <PageTypeSystem_Types_PlotAndHline>`, `lines <PageLinesAndBoxes_Lines>`, `boxes <PageLinesAndBoxes_Boxes>`, and
...
-   Other drawing types, namely
    ...
    `polylines <PageLinesAndBoxes_Polylines>`, have built-in properties that allow the drawings to
...
or `hline <PageTypeSystem_Types_PlotAndHline>` IDs returned by
[plot()](https://www.tradingview.com/pine-script-reference/v5/#fun_plot)
and
[hline()](https://www.tradingview.com/pine-script-reference/v5/#fun_hline)
function calls. The
...
[fill()](https://www.tradingview.com/pine-script-reference/v5/#fun_fill)
function works with
`plot and hline <PageTypeSystem_Types_PlotAndHline>` IDs. It calls
[plot()](https://www.tradingview.com/pine-script-reference/v5/#fun_plot)
and
[hline()](https://www.tradingview.com/pine-script-reference/v5/#fun_hline)
...
![image](@assets/concepts/Fills-Fill-2.png)
...
![image](@assets/concepts/Fills-Fill-3.png)
...
`plots or hlines <PageTypeSystem_Types_PlotAndHline>`, it does not work with
[line](https://www.tradingview.com/pine-script-reference/v5/#type_line)
objects. When a script needs to fill the space between
`lines <PageLinesAndBoxes_Lines>`, it
requires a
[linefill](https://www.tradingview.com/pine-script-reference/v5/#type_linefill)
...
![image](@assets/concepts/Fills-Linefill-01.png)
...
![image](@assets/concepts/Fills-Box-and-polyline-fills-1.png)
...
See this manual\'s
`Lines and boxes <PageLinesAndBoxes>` page
