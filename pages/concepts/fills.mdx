...
[hlines](/pine-script-docs/language/type-system#plot-and-hline), [lines](/pine-script-docs/concepts/lines-and-boxes#lines), [boxes](/pine-script-docs/concepts/lines-and-boxes#boxes), and
...
-   Other drawing types, namely
    ...
    [polylines](/pine-script-docs/concepts/lines-and-boxes#polylines), have built-in properties that allow the drawings to
...
[lines](/pine-script-docs/concepts/lines-and-boxes#lines), it
requires a
[linefill](https://www.tradingview.com/pine-script-reference/v5/#type_linefill)
...
See this manual\'s
[Lines and boxes](/pine-script-docs/concepts/lines-and-boxes) page
