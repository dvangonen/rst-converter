...
[Levels](/pine-script-docs/concepts/plots#levels) section of the
page on
[plot()](https://www.tradingview.com/pine-script-reference/v5/#plot) for
...
-   Its `color` parameter requires an \"input int\" argument, which
...
![image](@assets/concepts/Levels-HlineLevels-01.png)

![image](@assets/concepts/Levels-HlineLevels-02.png)
...
-   The usual range for the indicator\'s values is +100 to -100. Since
    the
    [ta.tsi()](https://www.tradingview.com/pine-script-reference/v5/#fun_ta%7Bdot%7Dtsi)
...
![image](@assets/concepts/Levels-FillBetweenLevels-01.png)

![image](@assets/concepts/Levels-FillBetweenLevels-02.png)
...
-   We have now used the return value of our
    ...
    [hline](/pine-script-docs/language/type-system#plot-and-hline) special type. We use the `plus50Hline`, `plus25Hline`,
