...
[Type system](/pine-script-docs/language/type-system). For more
information on user-defined functions and scopes, see the
[User-defined functions](/pine-script-docs/language/user-defined-functions) page.
...
-   The `// @description`, `// @function`, `// @param` and `// @returns`
    [compiler annotations](/pine-script-docs/language/script-structure#compiler-annotations) are optional but we highly recommend you use them. They
...
You can export
[user-defined types (UDTs)](/pine-script-docs/language/type-system#user-defined-types) from libraries, and library functions can return
