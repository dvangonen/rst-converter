...
Unlike [plots](/pine-script-docs/concepts/plots), the
...
[tables](/pine-script-docs/concepts/tables), and other *special
...
[arrays](/pine-script-docs/language/arrays), especially when
working with [polylines](/pine-script-docs/concepts/lines-and-boxes#polylines), which *require* an
...
-   [Lines](/pine-script-docs/concepts/lines-and-boxes#lines),
    [boxes](/pine-script-docs/concepts/lines-and-boxes#boxes), and
    [polylines](/pine-script-docs/concepts/lines-and-boxes#polylines) can have coordinates at any available location on the
...
`style`
    ...
    in this page\'s
    [Line styles](/pine-script-docs/concepts/lines-and-boxes#line-styles) section. The default value is
...
[line.new()](https://www.tradingview.com/pine-script-reference/v5/#fun_line.new)
within a [for](/pine-script-docs/language/loops#for) loop to
...
and
[line.set_color()](https://www.tradingview.com/pine-script-reference/v5/#fun_line.set_color)
as [methods](/pine-script-docs/language/methods) to update the
line\'s properties:
...
Note that:
    ...
    -   Each line drawing in this example uses the
        ...
        style. See the
        [Line styles](/pine-script-docs/concepts/lines-and-boxes#line-styles) section below for an overview of all available style
        settings.
...
Note that:
    ...
    -   *Polylines* can also use any of these variables as their
        ...
        [Creating polylines](/pine-script-docs/concepts/lines-and-boxes#creating-polylines) section of this page.
...
second point using
[line.get_price()](https://www.tradingview.com/pine-script-reference/v5/#fun_line.get_price)
and [plots](/pine-script-docs/concepts/plots) them on the chart:
...
[modify](/pine-script-docs/concepts/lines-and-boxes#modifying-lines) its properties. As we see below, altering the `copiedLine`
...
[uses as a queue](/pine-script-docs/language/arrays#using-an-array-as-aqueue) to only display the last `numberOfLines` on the chart. When
the
[size](https://www.tradingview.com/pine-script-reference/v5/#fun_array.size)
of the
[array](https://www.tradingview.com/pine-script-reference/v5/#type_array)
...
[linefill](https://www.tradingview.com/pine-script-reference/v5/#type_linefill)
type, see [this](/pine-script-docs/concepts/fills#line-fills)
section of the [Fills](/pine-script-docs/concepts/fills) page.
...
As with [lines](/pine-script-docs/concepts/lines-and-boxes#lines),
...
`border_style`
    ...
    in the
    [Box styles](/pine-script-docs/concepts/lines-and-boxes#box-styles) section of this page.
...
Note that:
    ...
    -   The `bottomRight` point\'s `index` field is one bar greater than
        ...
        page\'s
        [Creating lines](/pine-script-docs/concepts/lines-and-boxes#creating-lines) section.
    -   Similar to [lines](/pine-script-docs/concepts/lines-and-boxes#lines), if the `topLeft` and `bottomRight` contained
...
Note that, unlike [lines](/pine-script-docs/concepts/lines-and-boxes#lines), the `box.*` namespace does not contain a setter function to
modify a box\'s `xloc`. Users must
[create](/pine-script-docs/concepts/lines-and-boxes#creating-boxes) a new box with the desired `xloc` setting for such cases.
...
[modify](/pine-script-docs/concepts/lines-and-boxes#modifying-boxes) its properties. As shown on the chart below, these changes
...
values. The script
[creates](/pine-script-docs/concepts/lines-and-boxes#creating-boxes) a new box ID and stores it in a `boxes` array once every
...
[volume](https://www.tradingview.com/pine-script-reference/v5/#var_volume)
over each period by
[modifying](/pine-script-docs/concepts/lines-and-boxes#modifying-boxes) the `top` of the
[last](https://www.tradingview.com/pine-script-reference/v5/#fun_array.last)
box in the `boxes` array. The script then uses
[for loops](/pine-script-docs/language/loops#for) to find the
...
Unlike [lines](/pine-script-docs/concepts/lines-and-boxes#lines)
or [boxes](/pine-script-docs/concepts/lines-and-boxes#boxes),
...
`line_style`
    ...
    [Line styles](/pine-script-docs/concepts/lines-and-boxes#line-styles) section of this page. The default is
    [line.style_solid](https://www.tradingview.com/pine-script-reference/v5/#var_line.style_solid).
...
from each
[chart point](/pine-script-docs/language/type-system#chart-points) in the
[array](https://www.tradingview.com/pine-script-reference/v5/#type_array),
...
with [lines](/pine-script-docs/concepts/lines-and-boxes#lines) or
[boxes](/pine-script-docs/concepts/lines-and-boxes#boxes). When
...
[lines](/pine-script-docs/concepts/lines-and-boxes#lines), whereas
...
values, then uses a [for loop](/pine-script-docs/language/loops#for) to push `numberOfSides` new
...
[array](https://www.tradingview.com/pine-script-reference/v5/#type_array),
which it
[uses as a queue](/pine-script-docs/language/arrays#using-an-array-as-aqueue) to manage the number of drawings it displays.

When the `newSpiral` condition occurs, the script creates a `points`
array and adds
[chart points](/pine-script-docs/language/type-system#chart-points) within a [for loop](/pine-script-docs/language/loops#for). On each loop iteration, it calls the `spiralPoint()`
...
Note that:
    ...
    -   As with our \"N-sided polygons\" example in the
        [previous section](/pine-script-docs/concepts/lines-and-boxes#closed-shapes), we round the calculation of x-coordinates to the
...
[deletes](/pine-script-docs/concepts/lines-and-boxes#deleting-polylines) the polyline referenced by the `currentDrawing` before
[creating a new one](/pine-script-docs/concepts/lines-and-boxes#creating-polylines), resulting in a dynamic drawing that changes over the
developing period:
...
Scripts cannot use [lines](/pine-script-docs/concepts/lines-and-boxes#lines), [boxes](/pine-script-docs/concepts/lines-and-boxes#boxes), or
[polylines](/pine-script-docs/concepts/lines-and-boxes#polylines)
