...
| Argument                | Line                                                                                 |
|-------------------------|--------------------------------------------------------------------------------------|
| `line.style_solid`      | ![line_style_solid](@assets/concepts/LinesAndBoxes-LineStyles-solid.png)             |
| `line.style_dotted`     | ![line_style_dotted](@assets/concepts/LinesAndBoxes-LineStyles-dotted.png)           |
| `line.style_dashed`     | ![line_style_dashed](@assets/concepts/LinesAndBoxes-LineStyles-dashed.png)           |
| `line.style_arrow_left` | ![line_style_arrow_left](@assets/concepts/LinesAndBoxes-LineStyles-arrow_left.png)   |
| `line.style_arrow_right`| ![line_style_arrow_right](@assets/concepts/LinesAndBoxes-LineStyles-arrow_right.png) |
| `line.style_arrow_both` | ![line_style_arrow_both](@assets/concepts/LinesAndBoxes-LineStyles-arrow_both.png)   |
