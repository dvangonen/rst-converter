...
Note that:
    ...
    -   Unlike a plain
        ...
        [user-defined type](/pine-script-docs/language/type-system#user-defined-types) whose fields contain the desired elements to
        request.
...
[this section](/pine-script-docs/concepts/repainting#repainting-request-security-calls).
