...
-   Tables created with
    ...
    (see [Tables](/pine-script-docs/concepts/tables))

Which one to use depends on your needs:

-   Tables can display text in various relative positions on charts that
    ...
    [Tables](/pine-script-docs/concepts/tables) for more
    information on them.
...
-   The color or size of text can sometimes be controlled using function
    parameters, but no inline formatting (bold, italics, monospace,
    etc.) is possible.
-   Text from Pine scripts always displays on the chart in the Trebuchet
...
![image](@assets/concepts/TextAndShapes-Introduction-01.png)
...
See the [Reference Manual entry for
plotchar()](https://www.tradingview.com/pine-script-reference/v5/#fun_plotchar)
for details on its parameters.

As explained in the
[When the script's scale must be preserved](/pine-script-docs/writing/debugging#when-the-scripts-scale-must-be-preserved) section of our page on
...
![image](@assets/concepts/TextAndShapes-Plotchar-01.png)
...
-   The value of
    ...
    Window (2).
-   We use
    [location.top](https://www.tradingview.com/pine-script-reference/v5/#const_location%7Bdot%7Dtop)
    because the default
    [location.abovebar](https://www.tradingview.com/pine-script-reference/v5/#const_location%7Bdot%7Dabovebar)
...
![image](@assets/concepts/TextAndShapes-Plotchar-02.png)
...
[ta.tr](https://www.tradingview.com/pine-script-reference/v5/#var_ta%7Bdot%7Dtr)
(the bar\'s \"True Range\"):

![image](@assets/concepts/TextAndShapes-Plotchar-03.png)
...
![image](@assets/concepts/TextAndShapes-Plotshape-01.png)

It is possible to use different
[plotshape()](https://www.tradingview.com/pine-script-reference/v5/#fun_plotshape)
calls to superimpose text on bars. You will need to use `\n` followed by
...
character needs to be the **last** one in the string for text going up,
and the **first** one when you are plotting under the bar and text is
going down:
...
![image](@assets/concepts/TextAndShapes-Plotshape-02.png)

The available shapes you can use with the `style` parameter are:

 | Argument               | Shape                                                                                      | With Text                                                                                            | Argument              | Shape                                                                                | With Text
 | ---------------------- | ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------- | --------------------- | ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------- |
 | `shape.xcross`         | ![Plotshape_xcross](@assets/concepts/TextAndShapes-PlotshapeStyles-Xcross.png)             | ![Xcross_with_text](@assets/concepts/TextAndShapes-PlotshapeStyles-Xcross_with_text.png)             |     `shape.arrowup`   | ![Plotshape_arrowup](@assets/concepts/TextAndShapes-PlotshapeStyles-Arrowup.png)     | ![Arrowup_with_text](@assets/concepts/TextAndShapes-PlotshapeStyles-Arrowup_with_text.png)     |
 | `shape.cross`          | ![Plotshape_cross](@assets/concepts/TextAndShapes-PlotshapeStyles-Cross.png)               | ![Cross_with_text](@assets/concepts/TextAndShapes-PlotshapeStyles-Cross_with_text.png)               |     `shape.arrowdown` | ![Plotshape_arrowdown](@assets/concepts/TextAndShapes-PlotshapeStyles-Arrowdown.png) | ![Arrowdown_with_text](@assets/concepts/TextAndShapes-PlotshapeStyles-Arrowdown_with_text.png) |
 | `shape.circle`         | ![Plotshape_circle](@assets/concepts/TextAndShapes-PlotshapeStyles-Circle.png)             | ![Circle_with_text](@assets/concepts/TextAndShapes-PlotshapeStyles-Circle_with_text.png)             |     `shape.square`    | ![Plotshape_square](@assets/concepts/TextAndShapes-PlotshapeStyles-Square.png)       | ![Square_with_text](@assets/concepts/TextAndShapes-PlotshapeStyles-Square_with_text.png)       |
 | `shape.triangleup`     | ![Plotshape_triangleup](@assets/concepts/TextAndShapes-PlotshapeStyles-Triangleup.png)     | ![Triangleup_with_text](@assets/concepts/TextAndShapes-PlotshapeStyles-Triangleup_with_text.png)     |     `shape.diamond`   | ![Plotshape_diamond](@assets/concepts/TextAndShapes-PlotshapeStyles-Diamond.png)     | ![Diamond_with_text](@assets/concepts/TextAndShapes-PlotshapeStyles-Diamond_with_text.png)     |
 | `shape.triangledown`   | ![Plotshape_triangledown](@assets/concepts/TextAndShapes-PlotshapeStyles-Triangledown.png) | ![Triangledown_with_text](@assets/concepts/TextAndShapes-PlotshapeStyles-Triangledown_with_text.png) |     `shape.labelup`   | ![Plotshape_labelup](@assets/concepts/TextAndShapes-PlotshapeStyles-Labelup.png)     | ![Labelup_with_text](@assets/concepts/TextAndShapes-PlotshapeStyles-Labelup_with_text.png)     |
 | `shape.flag`           | ![Plotshape_flag](@assets/concepts/TextAndShapes-PlotshapeStyles-Flag.png)                 | ![Flag_with_text](@assets/concepts/TextAndShapes-PlotshapeStyles-Flag_with_text.png)                 |     `shape.labeldown` | ![Plotshape_labeldown](@assets/concepts/TextAndShapes-PlotshapeStyles-Labeldown.png) | ![Labeldown_with_text](@assets/concepts/TextAndShapes-PlotshapeStyles-Labeldown_with_text.png) |
...
![image](@assets/concepts/TextAndShapes-Plotarrow-01.png)

Note how the heigth of arrows is proportional to the relative size of
the bar bodies.
...
![image](@assets/concepts/TextAndShapes-Plotarrow-02.png)
...
[lines and boxes](/pine-script-docs/concepts/lines-and-boxes), or
[tables](/pine-script-docs/concepts/tables). Like them, they are
...
interface are not visible from Pine scripts.
:::
...
[lines and boxes](/pine-script-docs/concepts/lines-and-boxes), are
...
[Execution model](/pine-script-docs/#execution-model).
