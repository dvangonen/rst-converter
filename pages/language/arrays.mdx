...
or a
[user-defined type](/pine-script-docs/language/type-system#user-defined-types), always qualified as \"series\". Scripts reference arrays
using an array ID similar to the IDs of lines, labels, and other special
types. Pine Script™ does not use an indexing operator to reference
individual array elements. Instead, functions including
[array.get()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dget)
and
[array.set()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dset)
read and write the values of array elements. We can use array values in
expressions and functions that allow \"series\" values.

Scripts reference the elements of an array using an *index*, which
...
:::warning[Notice!]
We will use *beginning* of an array to designate index 0, and *end* of
an array to designate the array\'s element with the highest index value.
We will also extend the meaning of *array* to include array IDs, for the
sake of brevity.
:::
...
Where `<type>` is a
[type template](/pine-script-docs/language/type-system#type-templates) for the array that declares the type of values it will
...
[type template](/pine-script-docs/language/type-system#type-templates). Alternatively, we can use the `type` name followed by the
...
the following functions: [array.new\<type\>(size, initial_value)](https://www.tradingview.com/pine-script-reference/v5/#fun_array.new%3Ctype%3E),
...
For `array.new<type>(size, initial_value)` functions, the arguments of
the `size` and `initial_value` parameters can be \"series\" to allow
...
time, the array ID returned by the [array.new\<float\>()](https://www.tradingview.com/pine-script-reference/v5/#fun_array.new%3Ctype%3E)
...
:::warning[Notice!]
The `array.*` namespace also contains type-specific functions for
creating arrays, including
[array.new_int()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dnew_int),
[array.new_float()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dnew_float),
[array.new_bool()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dnew_bool),
[array.new_color()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dnew_color),
[array.new_string()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dnew_string),
[array.new_line()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dnew_line),
[array.new_linefill()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dnew_linefill),
[array.new_label()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dnew_label),
[array.new_box()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dnew_box)
and
[array.new_table()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dnew_table).
The [array.new\<type\>()](https://www.tradingview.com/pine-script-reference/v5/#fun_array.new%3Ctype%3E)
...
The `initial_value` parameter of `array.new*` functions allows users to
...
Users can utilize
[var](https://www.tradingview.com/pine-script-reference/v5/#kw_var) and
...
call, the
[a.size()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dsize)
call would return a value of 1.

:::warning[Notice!]
Array variables declared using
[varip](https://www.tradingview.com/pine-script-reference/v5/#kw_varip)
...
collections (arrays, [matrices](/pine-script-docs/language/matrices)) of
these types.
:::
...
[array.set(id, index,
value)](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dset),
and read using [array.get(id,
index)](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dget).
...
[array.size(id)](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dsize)
function.

The following example uses the
[set()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dset)
...
![image](@assets/language/Arrays-ReadingAndWriting-DistanceFromHigh.png)
...
index_to)](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dfill)
function points all array elements, or the elements within the
`index_from` to `index_to` range, to a specified `value`. Without the
...
with `close`. Note how
[array.fill()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dfill)\'s
...
[array.new()](https://www.tradingview.com/pine-script-reference/v5/#fun_array.new%3Ctype%3E)
...
[array.size()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dsize)
...
![image](@assets/language/Arrays-Scope-Bands.png)
...
\]](https://www.tradingview.com/pine-script-reference/v5/#op_%5B%5D) can
...
then uses the
[get()](https://www.tradingview.com/pine-script-reference/v5/#fun_array.get)
...
![image](@assets/language/Arrays-History-referencing.png)
...
![image](@assets/language/Arrays-InsertingAndRemovingArrayElements-Insert.png)
...
![image](@assets/language/Arrays-InsertingAndRemovingArrayElements-LowsFromNewHighs.png)
...
![image](@assets/language/Arrays-InsertingAndRemovingArrayElements-ShowLastnHighPivots.png)
...
[time series](/pine-script-docs/language/type-system#time-series),
...
[array.avg()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Davg),
[array.covariance()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dcovariance),
...
[array.median()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dmedian),
...
[array.range()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Drange),
[array.standardize()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dstandardize),
[array.stdev()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dstdev),
[array.sum()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dsum),
[array.variance()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dvariance).
...
[array.concat()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dconcat).
...
![image](@assets/language/Arrays-ManipulatingArrays-Concat.png)
...
![image](@assets/language/Arrays-ManipulatingArrays-Copy.png)
...
Use
[array.join()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Djoin)
...
[array.sort()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dsort).
The `order` parameter is optional and defaults to
[order.ascending](https://www.tradingview.com/pine-script-reference/v5/#const_order%7Bdot%7Dascending).
As all `array.*()` function arguments, it is qualified as \"series\", so
can be determined at runtime, as is done here. Note that in the example,
which array is sorted is also determined at runtime:

![image](@assets/language/Arrays-ManipulatingArrays-Sort.png)
...
this function won\'t modify the original array. The `order` parameter is
...
Use
[array.reverse()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dreverse)
to reverse an array:
...
[array.slice()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dslice)
...
![image](@assets/language/Arrays-ManipulatingArrays-Slice.png)
...
[array.includes()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dincludes)
function, which returns true if the element is found. We can find the
first occurrence of a value in an array by using the
[array.indexof()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dindexof)
function. The first occurence is the one with the lowest index. We can
also find the last occurrence of a value with
[array.lastindexof()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dlastindexof):
...
[v5 Reference
Manual](https://www.tradingview.com/pine-script-reference/v5/) when in
...
[input.int()](https://www.tradingview.com/pine-script-reference/v5/#fun_input%7Bdot%7Dint)\'s
...
See the [Looping](/pine-script-docs/language/arrays#looping)
