...
sidebar-title: Identifiers
page-title: Language / Identifiers
...
The Pine Script™ `Style Guide <PageStyleGuide>` recommends using uppercase SNAKE_CASE for constants, and
