...
-   Libraries must contain at least one exported
    [function](/pine-script-docs/concepts/libraries#functions)
    or [user-defined type](/pine-script-docs/concepts/libraries#objects).
...
-   [variable declaration](/pine-script-docs/expressions-declarations-statements#variable-declaration)
-   [variable reassignement](/pine-script-docs/expressions-declarations-statements#variable-reassignment)
-   [function declaration](/pine-script-docs/language/user-defined-functions#declaring-functions)
-   [built-in function call](/pine-script-docs/built-in-functions#calling-built-in-functions),
    [user-defined function call](/pine-script-docs/language/user-defined-functions) or
    [a library function call](/pine-script-docs/concepts/libraries#using-alibrary)
...
-   `//@type` and `//@field` add custom descriptions for a
    [user-defined type (UDT)](/pine-script-docs/language/type-system#user-defined-types) and its fields when placed above the type declaration.
