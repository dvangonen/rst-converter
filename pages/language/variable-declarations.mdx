...
-   \<declaration_mode\> is the variable\'s
    [declaration mode](/pine-script-docs/language/variable-declarations#declaration-modes). It can be
...
[Variable reassignment](/pine-script-docs/language/variable-declarations#variable-reassignment) section for details.
:::
...
-   If we did not use the
    [:=](/pine-script-docs/language/operators#reassignment-operator) reassignment operator, the effect would be to initialize
...
[declaration mode](/pine-script-docs/language/variable-declarations#declaration-modes) determines how new values assigned to a variable will be
saved.
