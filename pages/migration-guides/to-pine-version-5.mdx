...
Script™ v5. See our
[Release notes](/pine-script-docs/release-notes#october2021) for a list of the **new** features in Pine Script™ v5.
...
found in the
[Common script conversion errors](/pine-script-docs/to-pine-version5#common-conversion-errors) section of this guide.
...
[All variable, function, and parameter name changes](/pine-script-docs/to-pine-version5#all-variables) section of this guide.
...
See the
[Some function parameters now require built-in arguments](/pine-script-docs/to-pine-version5#some-function-parameters-now-require-built-in-arguments) section of this guide for more information.
