...
After your [first steps](/pine-script-docs/primer/first-steps)
and your [first indicator](/pine-script-docs/primer/first-indicator), let us explore a bit more of the Pine Script™ landscape by
sharing some pointers to guide you in your journey to learn Pine
Script™.

## \"indicators\" vs \"strategies\"

Pine Script™ [strategies](/pine-script-docs/concepts/strategies)
...
[Strategies](/pine-script-docs/concepts/strategies) for more
...
[time series](/pine-script-docs/language/time-series). Time
...
[time series](/pine-script-docs/language/time-series) is
...
[Publishing](/pine-script-docs/writing/publishing) for more
information.
...
-   The `Migration guides <IndexMigrationGuides>` section explains how to port between different versions
    of Pine Script™.
-   The
    [Where can I get more information](/pine-script-docs/where-can-iget-more-information) page lists other useful Pine Script™-related content,
