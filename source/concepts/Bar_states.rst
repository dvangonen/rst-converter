...
`barstate.isnew <https://www.tradingview.com/pine-script-reference/v5/#var_barstate{dot}isnew>`__ 
can be useful to reset `varip <https://www.tradingview.com/pine-script-reference/v5/#kw_varip>`__ variables when a new realtime bar comes in. 
...
- The label of elapsed realtime bars is orange because those bars were not historical bars when they closed.
  Accordingly, the ``barstate.ishistory => color.silver`` branch in the `switch <https://www.tradingview.com/pine-script-reference/v5/#kw_switch>`__
