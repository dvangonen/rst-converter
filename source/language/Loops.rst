...
A `for <https://www.tradingview.com/pine-script-reference/v5/#kw_for>`__
...
- The manipulation of collections (:ref:`arrays <PageArrays>`, :ref:`matrices <PageMatrices>`, and :ref:`maps <PageMaps>`).
...
The `for <https://www.tradingview.com/pine-script-reference/v5/#kw_for>`__ 
...
This example uses a `for <https://www.tradingview.com/pine-script-reference/v5/#kw_for>`__ 
...
A `for <https://www.tradingview.com/pine-script-reference/v5/#kw_for>`__ loop is necessary here, 
...
arrays must be checked on each bar, and there is no built-in that can do this for us:
...
The `while <https://www.tradingview.com/pine-script-reference/v5/#kw_while>`__ 
...
`while <https://www.tradingview.com/pine-script-reference/v5/#kw_while>`__ structure instead of a 
`for <https://www.tradingview.com/pine-script-reference/v5/#kw_for>`__ one:
...
- The ``i`` counter must be incremented by one explicitly inside the 
  `while <https://www.tradingview.com/pine-script-reference/v5/#kw_while>`__'s local block.
...
`while <https://www.tradingview.com/pine-script-reference/v5/#kw_while>`__ structure:
...
- We have packaged our script's functionality in a ``factorial()`` function which accepts as an argument
  ...
  which will prevent the execution of the `while <https://www.tradingview.com/pine-script-reference/v5/#kw_while>`__ loop
  because its ``counter > 0`` expression will return `na <https://www.tradingview.com/pine-script-reference/v5/#var_na>`__.
  The `while <https://www.tradingview.com/pine-script-reference/v5/#kw_while>`__ structure will thus
...
- Note the last line of the `while <https://www.tradingview.com/pine-script-reference/v5/#kw_while>`__'s local block: ``fact``.
  It is the local block's return value, so the value it had on the `while <https://www.tradingview.com/pine-script-reference/v5/#kw_while>`__
