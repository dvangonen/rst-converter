...
---------------------
..
   TODO: add a link when the Declaration Statements page is finished :ref:`declaration statement <PageDeclarationStatements>`,
...
- `if <https://www.tradingview.com/pine-script-reference/v5/#kw_if>`__,
  ...
  `while <https://www.tradingview.com/pine-script-reference/v5/#kw_while>`__, 
  `switch <https://www.tradingview.com/pine-script-reference/v5/#kw_switch>`__ or
  `type <https://www.tradingview.com/pine-script-reference/v5/#kw_type>`__ *structure*.
...
and two in the variable declaration using an `if <https://www.tradingview.com/pine-script-reference/v5/#kw_if>`__ structure:
...
Compiler annotations are :ref:`comments <PageScriptStructure_Comments>` that issue special instructions for a script:
...
- ``//@description`` sets a custom description for scripts that use the `library() <https://www.tradingview.com/pine-script-reference/v5/#fun_library>`__ declaration statement.
...
- ``//@type`` and ``//@field`` add custom descriptions for a :ref:`user-defined type (UDT) <PageTypeSystem_UserDefinedTypes>` and its fields when placed above the type declaration.
