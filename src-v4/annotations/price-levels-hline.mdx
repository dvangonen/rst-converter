...
sidebar-title: Price levels, hline
page-title: Annotations / Price levels, hline

---
# Price levels, hline

The
[hline](https://www.tradingview.com/pine-script-reference/v4/#fun_hline)
...
![image](@assets/annotations/Price_levels_hline_1.png)
