...
sidebar-title: HOWTOs
page-title: Appendix / HOWTOs
...
![image](@assets/appendix/Buy_sell_chart1.png)
...
![image](@assets/appendix/Buy_sell_chart2.png)
...
![Mark the highest bar within a 5 day lookback window
range](@assets/appendix/Wiki_howto_range_analysis.png)
