...
sidebar-title: Pine version 3 migration guide
page-title: Appendix / Pine version 3 migration guide
...
We worked on this and made changes in Pine version 3. If this indicator
is compiled with `//@version=3` directive, we get a completely different
picture: ![](@assets/appendix/V3.png)
...
version 3 this will give you an error `Undeclared identifier 'f'`. This
example should be rewritten in Pine version 3 as follows:
...
i.e., in version 2. It can be resolved as before: wrap the code with a
mutable variable in a function:
