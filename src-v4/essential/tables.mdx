...
plots or objects drawn in Pine, tables are not anchored to specific
bars; they *float* in a script\'s space, whether in overlay or pane
mode, in studies or strategies, independently of the chart bars being
...
1.  A table\'s structure and key attributes are defined using
    [table.new()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dnew),
...
2.  Once created, and for it to display, the table must be populated
    using one
    [table.cell()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dcell)
...
anchored to the `position.middle_right` reference will be drawn by
...
[table.set_position()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dset_position),
[table.set_bgcolor()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dset_bgcolor),
[table.set_frame_color()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dset_frame_color),
[table.set_frame_width()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dset_frame_width),
[table.set_border_color()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dset_border_color)
and
[table.set_border_width()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dset_border_width).

Tables can be deleted using
[table.delete()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Ddelete),
and their content can be selectively removed using
[table.clear()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dclear).
...
setter functions:
[table.cell_set_text()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dcell_set_text),
[table.cell_set_width()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dcell_set_width),
[table.cell_set_height()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dcell_set_height),
[table.cell_set_text_color()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dcell_set_text_color),
[table.cell_set_text_halign()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dcell_set_text_halign),
[table.cell_set_text_valign()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dcell_set_text_valign),
[table.cell_set_text_size()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dcell_set_text_size)
and
[table.cell_set_bgcolor()](https://www.tradingview.com/pine-script-reference/v4/#fun_table%7Bdot%7Dcell_set_bgcolor).
...
![image](@assets/essential/Tables-ATR-1.png)
...
-   We call `atr(14)` prior to entry in our
    [if](https://www.tradingview.com/pine-script-reference/v4/#op_if)
    block so that it evaluates on each bar. Had we used
    `tostring(atr(14))` inside the
    [if](https://www.tradingview.com/pine-script-reference/v4/#op_if)
...
![image](@assets/essential/Tables-ATR-2.png)
...
-   We used the `f_tickFormat()` function to restrict the precision of
    ATR to the chart\'s tick precision.
...
-   We provide users with inputs allowing them to specify the bull/bear
    ...
    arguments to our `f_colorChartBg()` function.
...
[open](https://www.tradingview.com/pine-script-reference/v4/#var_open)
and
[close](https://www.tradingview.com/pine-script-reference/v4/#var_close),
the cell\'s background is of the neutral color.

![image](@assets/essential/Tables-DisplayPanel-1.png)
...
![image](@assets/essential/Tables-Heatmap-1.png)
...
-   We define a maximum lookback period as a `MAX_LOOKBACK` constant.
    ...
    in our function, so that we force Pine to create a historical buffer
    size that will allow us to refer to the required quantity of past
    values of `_src` in our
...
-   Contrary to other objects displayed in Pine scripts, this heatmap\'s
    ...
    scaled.
-   The maximum number of cells that can be displayed in the scritp\'s
...
-   When creating tables in strategy scripts, keep in mind that unless
    ...
    in [if](https://www.tradingview.com/pine-script-reference/v4/#op_if)
    [barstate.islast](https://www.tradingview.com/pine-script-reference/v4/#var_barstate%7Bdot%7Dislast)
