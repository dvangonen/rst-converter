...
[strategy.opentrades](https://www.tradingview.com/pine-script-reference/v5/#var_strategy%7Bdot%7Dopentrades)
or
...
-   We use the `stop` parameter in our
    ...
    only execute once price is lower than the [low]{.title-ref} on the
...
`Repainting <PageRepainting>`{.interpreted-text role="ref"} section may
