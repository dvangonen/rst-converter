...
`plots <PageTypeSystem_Types_PlotAndHline>`{.interpreted-text
role="ref"},
`hlines <PageTypeSystem_Types_PlotAndHline>`{.interpreted-text
role="ref"}, `lines <PageLinesAndBoxes_Lines>`{.interpreted-text
...
-   Other drawing types, namely
    ...
    `polylines <PageLinesAndBoxes_Polylines>`{.interpreted-text
    role="ref"}, have built-in properties that allow the drawings to
...
`plot <PageTypeSystem_Types_PlotAndHline>`{.interpreted-text role="ref"}
or `hline <PageTypeSystem_Types_PlotAndHline>`{.interpreted-text
role="ref"} IDs returned by
[plot()](https://www.tradingview.com/pine-script-reference/v5/#fun_plot)
and
[hline()](https://www.tradingview.com/pine-script-reference/v5/#fun_hline)
function calls. The
...
[fill()](https://www.tradingview.com/pine-script-reference/v5/#fun_fill)
function works with
`plot and hline <PageTypeSystem_Types_PlotAndHline>`{.interpreted-text
role="ref"} IDs. It calls
[plot()](https://www.tradingview.com/pine-script-reference/v5/#fun_plot)
and
[hline()](https://www.tradingview.com/pine-script-reference/v5/#fun_hline)
...
![image](@assets/concepts/Fills-Fill-1.png)
...
`plots or hlines <PageTypeSystem_Types_PlotAndHline>`{.interpreted-text
role="ref"}, it does not work with
[line](https://www.tradingview.com/pine-script-reference/v5/#type_line)
objects. When a script needs to fill the space between
`lines <PageLinesAndBoxes_Lines>`{.interpreted-text role="ref"}, it
requires a
[linefill](https://www.tradingview.com/pine-script-reference/v5/#type_linefill)
...
[box](https://www.tradingview.com/pine-script-reference/v5/#type_box) on
...
See this manual\'s
`Lines and boxes <PageLinesAndBoxes>`{.interpreted-text role="ref"} page
