...
`Levels <PagePlots_Levels>`{.interpreted-text role="ref"} section of the
page on
...
-   We have now used the return value of our
    ...
    `hline <PageTypeSystem_Types_PlotAndHline>`{.interpreted-text
    role="ref"} special type. We use the `plus50Hline`, `plus25Hline`,
