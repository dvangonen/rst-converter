...
function calls:
  ...
  --------------------- ------------------------------------------------------------------ -- -------------------------- ----------------------------------------------------------------------------
  `line.style_solid`    ![line_style_solid](images/LinesAndBoxes-LineStyles-solid.png)        `line.style_arrow_left`    ![line_style_arrow_left](images/LinesAndBoxes-LineStyles-arrow_left.png)

  `line.style_dotted`   ![line_style_dotted](images/LinesAndBoxes-LineStyles-dotted.png)      `line.style_arrow_right`   ![line_style_arrow_right](images/LinesAndBoxes-LineStyles-arrow_right.png)

  `line.style_dashed`   ![line_style_dashed](images/LinesAndBoxes-LineStyles-dashed.png)      `line.style_arrow_both`    ![line_style_arrow_both](images/LinesAndBoxes-LineStyles-arrow_both.png)
  ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function calls to set the border styles of boxes drawn by their scripts:
  ...
  Argument                     Box
  ---------------------------- ----------------------------------------------------------------
  `line.style_solid`           ![box_style_solid](images/LinesAndBoxes-BoxStyles-solid.png)

  `line.style_dotted`          ![box_style_dotted](images/LinesAndBoxes-BoxStyles-dotted.png)

  `line.style_dashed`          ![box_style_dashed](images/LinesAndBoxes-BoxStyles-dashed.png)
  ---------------------------------------------------------------------------------------------
