...
`lines and boxes <PageLinesAndBoxes>`{.interpreted-text role="ref"}, are
...
These are the available `style` arguments:
  ...
  ---------------------------- -------------------------------------------------------------------------------- ------------------------------------------------------------------------------------ -- --------------------------------- ---------------------------------------------------------------------------------------- --------------------------------------------------------------------------------------------
  `label.style_xcross`         ![label_style_xcross](images/TextAndShapes-LabelStyles-xcross.png)               ![label_style_xcross_t](images/TextAndShapes-LabelStyles-xcross_t.png)                  `label.style_label_up`            ![label_style_label_up](images/TextAndShapes-LabelStyles-labelup.png)                    ![label_style_label_up_t](images/TextAndShapes-LabelStyles-labelup_t.png)

  `label.style_cross`          ![label_style_cross](images/TextAndShapes-LabelStyles-cross.png)                 ![label_style_cross_t](images/TextAndShapes-LabelStyles-cross_t.png)                    `label.style_label_down`          ![label_style_label_down](images/TextAndShapes-LabelStyles-labeldown.png)                ![label_style_label_down_t](images/TextAndShapes-LabelStyles-labeldown_t.png)

  `label.style_flag`           ![label_style_flag](images/TextAndShapes-LabelStyles-flag.png)                   ![label_style_flag_t](images/TextAndShapes-LabelStyles-flag_t.png)                      `label.style_label_left`          ![label_style_label_left](images/TextAndShapes-LabelStyles-labelleft.png)                ![label_style_label_left_t](images/TextAndShapes-LabelStyles-labelleft_t.png)

  `label.style_circle`         ![label_style_circle](images/TextAndShapes-LabelStyles-circle.png)               ![label_style_circle_t](images/TextAndShapes-LabelStyles-circle_t.png)                  `label.style_label_right`         ![label_style_label_right](images/TextAndShapes-LabelStyles-labelright.png)              ![label_style_label_right_t](images/TextAndShapes-LabelStyles-labelright_t.png)

  `label.style_square`         ![label_style_square](images/TextAndShapes-LabelStyles-square.png)               ![label_style_square_t](images/TextAndShapes-LabelStyles-square_t.png)                  `label.style_label_lower_left`    ![label_style_label_lower_left](images/TextAndShapes-LabelStyles-labellowerleft.png)     ![label_style_label_lower_left_t](images/TextAndShapes-LabelStyles-labellowerleft_t.png)

  `label.style_diamond`        ![label_style_diamond](images/TextAndShapes-LabelStyles-diamond.png)             ![label_style_diamond_t](images/TextAndShapes-LabelStyles-diamond_t.png)                `label.style_label_lower_right`   ![label_style_label_lower_right](images/TextAndShapes-LabelStyles-labellowerright.png)   ![label_style_label_lower_right_t](images/TextAndShapes-LabelStyles-labellowerright_t.png)

  `label.style_triangleup`     ![label_style_triangleup](images/TextAndShapes-LabelStyles-triangleup.png)       ![label_style_triangleup_t](images/TextAndShapes-LabelStyles-triangleup_t.png)          `label.style_label_upper_left`    ![label_style_label_upper_left](images/TextAndShapes-LabelStyles-labelupperleft.png)     ![label_style_label_upper_left_t](images/TextAndShapes-LabelStyles-labelupperleft_t.png)

  `label.style_triangledown`   ![label_style_triangledown](images/TextAndShapes-LabelStyles-triangledown.png)   ![label_style_triangledown_t](images/TextAndShapes-LabelStyles-triangledown_t.png)      `label.style_label_upper_right`   ![label_style_label_upper_right](images/TextAndShapes-LabelStyles-labelupperright.png)   ![label_style_label_upper_right_t](images/TextAndShapes-LabelStyles-labelupperright_t.png)

  `label.style_arrowup`        ![label_style_arrowup](images/TextAndShapes-LabelStyles-arrowup.png)             ![label_style_arrowup_t](images/TextAndShapes-LabelStyles-arrowup_t.png)                `label.style_label_center`        ![label_style_label_center](images/TextAndShapes-LabelStyles-labelcenter.png)            ![label_style_label_center_t](images/TextAndShapes-LabelStyles-labelcenter_t.png)

  `label.style_arrowdown`      ![label_style_arrowdown](images/TextAndShapes-LabelStyles-arrowdown.png)         ![label_style_arrowdown_t](images/TextAndShapes-LabelStyles-arrowdown_t.png)            `label.style_none`                                                                                                         ![label_style_none_t](images/TextAndShapes-LabelStyles-none_t.png)
  -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

When using
[xloc.bar_time](https://www.tradingview.com/pine-script-reference/v5/#const_xloc%7Bdot%7Dbar_time),
the `x` value must be a UNIX timestamp in milliseconds. See the page on
`Time <PageTime>`{.interpreted-text role="ref"} for more information.
...
`Execution model <Page_ExecutionModel>`{.interpreted-text role="ref"}.
