...
-   They must be used in
    ...
    role="ref"} to explore the use of
    [request.security()](https://www.tradingview.com/pine-script-reference/v5/#fun_request%7Bdot%7Dsecurity).
-   They can be used as an argument to
    ...
    [request.security()](https://www.tradingview.com/pine-script-reference/v5/#fun_request%7Bdot%7Dsecurity).
    See the
    `Testing for changes in higher timeframes <PageTime_TestingForChangesInHigherTimeframes>`{.interpreted-text
    role="ref"} section to see how to do this.
-   The
    ...
    `Timeframe input <PageInputs_TimeframeInput>`{.interpreted-text
...
-   Many built-in variables provide information on the timeframe used by
    ...
    `Chart timeframe <PageChartInformation_ChartTimeframe>`{.interpreted-text
    role="ref"} section for more information on them, including
