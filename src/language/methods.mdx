...
sidebar-title: Methods
page-title: Language / Methods
labels: advanced
---
...
instances of built-in or user-defined
`types <PageTypeSystem>`. They are
essentially the same as regular functions in most regards but offer a
shorter, more convenient syntax. Users can access methods using dot
notation on variables directly, just like accessing the fields of a Pine
Script™ `object <PageObjects>`.
...
[get()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dget)
...
![image](@assets/language/Methods_custom_bb.png)
...
[push()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dpush)
and
[shift()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dshift)
...
Note that:
    ...
    -   Just as with user-defined functions, we use the `@function`
        `compiler annotation <PageScriptStructure_CompilerAnnotations>` to document method descriptions.
...
[avg()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Davg)
and
[stdev()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dstdev)
...
[set_text()](https://www.tradingview.com/pine-script-reference/v5/#fun_label%7Bdot%7Dset_text)
method:

![image](@assets/language/Methods_overloads_type_inspection.png)
...
[fill()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dfill)
...
[min()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Dmin)
and
[range()](https://www.tradingview.com/pine-script-reference/v5/#fun_array%7Bdot%7Drange)
...
![image](@assets/language/Methods_empirical_distribution.png)
