...
sidebar-title: To Pine Script™ version 4
page-title: Migration_guides / To Pine Script™ version 4
---
...
The Pine Editor comes with a utility to automatically convert v3
indicators and strategies to v4. To access it, open a script with
`//@version=3` in it and select the `Convert to v4` option in the `More`
dropdown menu:

![image](@assets/migration_guides/v3_to_v4_convert_button.png)
