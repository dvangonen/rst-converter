...
sidebar-title: To Pine Script™ version 5
page-title: Migration_guides / To Pine Script™ version 5
---
...
Script™ v5. See our
`Release notes <PageReleaseNotes_October2021>` for a list of the **new** features in Pine Script™ v5.
...
The Pine Editor includes a utility to automatically convert v4 scripts
to v5. To access it, open a script with `//@version=4` in it and select
the \"Convert to v5\" option in the \"More\" menu identified by three
dots at the top-right of the Editor\'s pane:

![image](@assets/migration_guides/v4_to_v5_convert_button.png)
...
found in the
`Common script conversion errors <PageToPineVersion5_CommonConversionErrors>` section of this guide.
...
![image](@assets/migration_guides/v5_autocomplete.png)
...
`All variable, function, and parameter name changes <PageToPineVersion5_AllVariables>` section of this guide.
...
manual\'s page on `Sessions <PageSessions>` for more information.
...
See the
`Some function parameters now require built-in arguments <PageToPineVersion5_SomeFunctionParametersNowRequireBuiltInArguments>` section of this guide for more information.
...
See the User Manual\'s page on `Inputs <PageInputs>`, and the
`Some function parameters now require built-in arguments <PageToPineVersion5_SomeFunctionParametersNowRequireBuiltInArguments>` section of this guide for more information.
